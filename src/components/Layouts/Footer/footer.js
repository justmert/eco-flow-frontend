...
export default function Footer() {
  ...
  return (
    <div className="site-footer">
      ...
      <section className="relative py-4 bg-white overflow-hidden footer-item ">
        <div className="relative z-10 container mx-auto max-w-7xl">
          <div className="flex flex-wrap justify-between items-center">
            <div className="w-auto">
              <a
                className="follow-me-button fork-me widget-button widget-button-small"
                target="_blank"
                rel="noreferrer"
            ...
            <div className="w-auto">
              <p className="p-5 text-gray-600 hover:text-gray-700 font-medium">
                Made with{" "}
            ...
            <div className="w-auto">
              <div className="flex flex-wrap -m-1.5">
                <div className="w-auto p-1.5">
                  <a
                    className="follow-me-button widget-button widget-button-small"
                    target="_blank"
                    rel="noreferrer"
                ...
                <div className="w-auto p-1.5">
                  <a
                    className="follow-me-twitter follow-me-button widget-button widget-button-small"
                    target="_blank"
                    rel="noreferrer"
                ...
                <div className="w-auto p-1.5">
                  <a
                    className="follow-me-github follow-me-button widget-button widget-button-small"
                    target="_blank"
                    rel="noreferrer"
